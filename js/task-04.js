...
// в начало value
// Метод pad(str) - получает парметр str (строку) и добавляет ее в на
// чало и в конец _value
...
class StringBuilder {
  ...
  pad(str) {
    this._value = this._value.concat(str, this._value);
    // this._value = this._value + str + this._value;
  }
}
